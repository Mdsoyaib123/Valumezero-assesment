      ...
      <div className="w-full lg:w-[979.93px] mx-auto pt-5 text[12px]">
        ...
        <div className="lg:flex justify-between pt-5 px-4 lg:px-0 ">
          <div>
            ...
            <h3 className="font-bold pt-4">Apple Wallet</h3>
            <ul className="space-y-2 pt-3">
              <li>Wallet</li>
              <li>Apple Card</li>
              <li>Apple Pay</li>
          ...
          <div>
            ...
            <h3 className="font-bold pt-4">Entertainment</h3>
            <ul className="space-y-2 pt-3">
              <li>Apple One</li>
              <li> Apple One</li>
              <li> Apple TV+</li>
          ...
          <div>
            ...
            <h3 className="font-bold pt-4">For Education</h3>
            <ul className="space-y-2 pt-3 ">
              <li>Apple and Education</li>
              <li>Shop for K-12</li>
              <li>Shop for College</li>
            </ul>
            <h3 className="font-bold pt-4">For Healthcare</h3>
            <ul className="space-y-2 pt-3 ">
              <li>Apple in Healthcare</li>
              <li>Health on Apple Watch</li>
              <li>Health Records on iPhone</li>
            </ul>
            <h3 className="font-bold pt-4">For Government</h3>
            <ul className="space-y-2 pt-3 ">
          ...
          <div>
            <h3 className="font-bold">Apple Values</h3>
            <ul className="space-y-2 pt-3 ">
              <li>Accessibility</li>
              <li>Education</li>
              <li>Environment</li>
            ...
            <h3 className="font-bold pt-4">About Apple</h3>
            <ul className="space-y-2 pt-3 ">
              <li>Newsroom</li>
